...
date: 2019-07-13 11:12:00-0400
description: list of resources for ml
tags: resource
categories: resource
---
...
* **[Personal Favourites](#personal-favourites)**  

* **[Some Nice Blogs](#blogs)**
...
1. Probabilistic Machine Learning - [Book 0](https://probml.github.io/pml-book/book0.html), [Book 1](https://probml.github.io/pml-book/book1.html), [Book 2](https://probml.github.io/pml-book/book2.html) by Kevin Murphy (really nice books)
...
3. [Cognitive Modeling](http://books.ranvier.ir/download.php?file=Cognitive_Model%20Thad%20A.%20Polk%20Colleen%20M.Seifert.pdf) by Thad A. Polk and Colleen M. Seifert.
4. [The Information Theory, Pattern Recognition, and Neural Networks Lecture Series](https://www.youtube.com/watch?v=BCiZc0n6COY&list=PLruBu5BI5n4aFpG32iMbdWoRVAA-Vcso6) by David MackKay (gives essence of Bayesian Inference and how it connects with Neural Networks).
5. [Information Theory, Inference, and Learning Algorithms](http://www.inference.org.uk/itprnn/book.pdf) by David J.C. MacKay (this is the course book for above mentioned lecture series, Do Read!).
6. [Christopher Olah's Blog](https://colah.github.io/) - Nicely explained concepts and many exciting things!


### Some Nice Blogs

1. [Andrej Karpathy blog](http://karpathy.github.io/) some really nice blogs by Andrej Karpathy
2. [Christopher Olah's Blog](https://colah.github.io/) - Nicely explained concepts One should have a look if interested in some Insights to Neural Networks.
3. [Obsession with Regression](http://obsessionwithregression.blogspot.com/) by Emma Pierson.
4. [Julia Galef's Blog](https://juliagalef.com/)
5. [Yoshua Bengio's Blogs](https://yoshuabengio.org/)
6. [AIWierdness](https://aiweirdness.com/) some "Wierd" things here.
7. [Otoro.net](https://otoro.net/) some really simple things which use DL and seems very cool.
8. [Machine Learning Research Blog](https://francisbach.com/) by Francis Bach (useful for Researchers to get insight).
9. [Google AI Blog](https://ai.googleblog.com/)
10. [OpenAI Blog](https://openai.com/blog/)
11. [DeepMind Blog](https://deepmind.com/blog)
12. [Berkeley Artificial Intelligence Research (BAIR)](https://bair.berkeley.edu/blog/)
13. [MIT News](http://news.mit.edu/topic/machine-learning)
14. [The Batch](https://www.deeplearning.ai/thebatch/) deeplearning.ai's weekly newsletter.
15. [KDnuggets](https://www.kdnuggets.com/tag/machine-learning)


### Free Online Books

1.  [Neural Networks and Deep Learning](http://neuralnetworksanddeeplearning.com/) by  Michael Nielsen (Dec 2014)
2.  [Deep Learning](http://research.microsoft.com/pubs/209355/DeepLearning-NowPublishing-Vol7-SIG-039.pdf) by Microsoft Research (2013) 
3.  [Deep Learning Tutorial](http://deeplearning.net/tutorial/deeplearning.pdf) by LISA lab, University of Montreal (Jan 6 2015)
4.  [neuraltalk](https://github.com/karpathy/neuraltalk) by Andrej Karpathy : numpy-based RNN/LSTM implementation
...
8.  [Artificial intelligence and machine learning: Topic wise explanation](https://leonardoaraujosantos.gitbooks.io/artificial-inteligence/)
9. [Machine Learning - A Probabilistic Perspective](https://doc.lagout.org/science/Artificial%20Intelligence/Machine%20learning/Machine%20Learning_%20A%20Probabilistic%20Perspective%20%5BMurphy%202012-08-24%5D.pdf) by Kevin Murphy.
10. [Cognitive Modeling](http://books.ranvier.ir/download.php?file=Cognitive_Model%20Thad%20A.%20Polk%20Colleen%20M.Seifert.pdf) by Thad A. Polk and Colleen M. Seifert.
...
20. [Neural Networks](http://info.usherbrooke.ca/hlarochelle/neural_networks/content.html): by Hugo Larochelle.
